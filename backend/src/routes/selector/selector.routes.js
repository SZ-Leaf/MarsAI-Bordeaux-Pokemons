...
import { createSelectorMemo, getPlaylist, addSubmissionToPlaylist, removeSubmissionFromPlaylist } from "../../controllers/selector/selector_memo.controller.js";
...
router.post('/rate/:id', authenticate, createSelectorMemo);
