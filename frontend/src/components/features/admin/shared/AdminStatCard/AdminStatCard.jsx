...
const AdminStatCard = ({ 
  ...
  // Transformation dynamique du nom de la classe de couleur pour le conteneur d'icône
  const iconBgClass = iconColor.replace('text', 'bg').replace('-400', '-500');

  return (
    <div className="stat-card">
      <div className="flex justify-between items-start">
        <div className={`admin-stat-icon-container ${iconBgClass}/10`}>
